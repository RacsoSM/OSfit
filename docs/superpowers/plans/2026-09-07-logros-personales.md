...
- [x] **Step 1: Crear `InsigniaImagenUtil` con el cuerpo actual de `MedallaImagenUtil`**
...
- [x] **Step 2: Reemplazar `MedallaImagenUtil` por una fachada**
...
- [x] **Step 3: Crear `LogroPersonalImagenUtil`**
...
- [x] **Step 4: Verificar que compila y nada se rompió**
...
- [x] **Step 3: Agregar la escena al sealed class**
...
- [x] **Step 4: Agregar la duración en el timeline**
...
- [x] **Step 5: Agregar la rama provisional en el renderer para que compile**
...
- [x] **Step 3: Agregar el parámetro a `construirEscenas`**
...
- [x] **Step 4: Resolver los bitmaps y agrupar en `generarYCompartir`**
...
- [x] **Step 1: Generalizar `dibujarInsigniaMedalla`**
...
- [x] **Step 2: Reemplazar la rama provisional en `lineasDeEscena`**
...
- [x] **Step 3: Dibujar las insignias**
...
- [x] **Step 4: Verificar que compila y los tests siguen pasando**
...
- [x] **Step 4: Registrarla en el NavHost**
...
- [x] **Step 5: Agregar la entrada al drawer**
...
- [x] **Step 6: Verificar que compila y los tests siguen pasando**
...
- [x] **Step 1: Exponer los flows y las acciones en `ClienteDetailViewModel`**
...
- [x] **Step 3: Agregar la ruta y registrarla**
...
- [x] **Step 4: Agregar la tarjeta al perfil**
...
- [x] **Step 1: Crear `ConfirmarLogrosDialog`**
...
- [x] **Step 2: Extender el ViewModel**
...
- [x] **Step 3: Encadenar los dos diálogos en `ClienteDetailScreen`**
...
- [x] **Step 4: Verificar que compila y todos los tests pasan**
...
- [x] **Step 1: Instalar en el dispositivo**
...
- [x] **Step 2: Crear el catálogo** *(4 logros creados, todos sin imagen propia; el
  entrenador agrega las imágenes — falta por eso cubrir el caso "insignia con imagen")*
...
- [ ] **Step 3: Verificar el caso de 1 logro** *(video generado sin errores, 1725 frames =
...
- [ ] **Step 4: Verificar el caso de 3 logros** *(el diálogo confirmó "3 logro(s) — salen en
  1 escena" y el video se generó sin errores; falta la revisión visual del entrenador)*
...
- [x] **Step 5: Verificar el caso de 4 logros y la idempotencia** *(idempotencia confirmada:
  tras las corridas de 1, 3 y 4 logros sobre la misma quincena quedaron exactamente 4
  registros, no 8. Las 2 escenas se confirmaron por duración: 1995 frames = 1530 + 270
  (9000 ms, 3 logros) + 195 (6500 ms, 1 logro). Falta la revisión visual del layout.)*
...
- [x] **Step 6: Verificar que semanal y mensual no cambiaron** *(mensual verificado en
  dispositivo: pasa directo a generar, sin diálogo de medalla ni de logros, y el video sale
  con 1335 frames — sin escena de logros. El semanal no es alcanzable desde el perfil del
  cliente: sólo hay botones de quincenal y mensual, y `generarResumenSemanal` llama al
  generador sin `logrosOtorgados`, así que no puede traer la escena.)*
...
- [x] **Step 7: Verificar el caso de cero logros** *(generó sin fallar, 1530 frames — sin
  escena de logros — y la lista vacía limpió los 4 registros de la quincena, que es el
